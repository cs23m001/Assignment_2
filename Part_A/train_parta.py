...
def parse_argument():
    ...
    parser.add_argument("--filters", nargs='+', type=int, default=[32, 64, 64, 128, 128], help="List of filter sizes for convolutional layers")
    parser.add_argument("--kernel_size", nargs='+', type=int, default=[3, 3, 3, 5, 5], help="List of kernel sizes for convolutional layers")
    parser.add_argument("--dense_size", type=int, default=512, help="Size of dense layer")
    parser.add_argument("--conv_activation", type=str, default='gelu', help="Activation function for convolutional layers")
    parser.add_argument("--dense_activation", type=str, default='mish', help="Activation function for dense layer")
