...
def evaluate(config):
    ...
    model = Model(dense_size = 512, activation = 'relu', dropout = 0.4)
    model.to(device)
...
def parse_argument():
    ...
    parser.add_argument("-mp", "--model_path", help="Path to the pre-trained", type=str, default='part_b_fine_tune_best_model.pth')
    
    return parser.parse_args()

if __name__ == "__main__":
    train_config = parse_argument()
